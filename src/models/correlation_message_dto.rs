...
pub struct CorrelationMessageDto {
    ...
    pub correlation_keys:
        Option<::std::collections::HashMap<String, crate::models::VariableValueDto>>,
    ...
    #[serde(
        rename = "localCorrelationKeys",
        skip_serializing_if = "Option::is_none"
    )]
    pub local_correlation_keys:
        Option<::std::collections::HashMap<String, crate::models::VariableValueDto>>,
    ...
    #[serde(
        rename = "processVariablesLocal",
        skip_serializing_if = "Option::is_none"
    )]
    pub process_variables_local:
        Option<::std::collections::HashMap<String, crate::models::VariableValueDto>>,
    ...
    #[serde(
        rename = "variablesInResultEnabled",
        skip_serializing_if = "Option::is_none"
    )]
