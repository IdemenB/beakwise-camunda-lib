...
pub struct ProcessInstanceQueryDto {
    ...
    #[serde(
        rename = "processDefinitionKeyNotIn",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "processDefinitionWithoutTenantId",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "variableNamesIgnoreCase",
        skip_serializing_if = "Option::is_none"
    )]
    ...
    #[serde(
        rename = "variableValuesIgnoreCase",
        skip_serializing_if = "Option::is_none"
    )]
