...
pub struct DeploymentWithDefinitionsDto {
    ...
    #[serde(
        rename = "deployedProcessDefinitions",
        skip_serializing_if = "Option::is_none"
    )]
    pub deployed_process_definitions:
        Option<::std::collections::HashMap<String, crate::models::ProcessDefinitionDto>>,
    ...
    #[serde(
        rename = "deployedDecisionDefinitions",
        skip_serializing_if = "Option::is_none"
    )]
    pub deployed_decision_definitions:
        Option<::std::collections::HashMap<String, crate::models::DecisionDefinitionDto>>,
    ...
    #[serde(
        rename = "deployedDecisionRequirementsDefinitions",
        skip_serializing_if = "Option::is_none"
    )]
    pub deployed_decision_requirements_definitions: Option<
        ::std::collections::HashMap<String, crate::models::DecisionRequirementsDefinitionDto>,
    >,
    ...
    #[serde(
        rename = "deployedCaseDefinitions",
        skip_serializing_if = "Option::is_none"
    )]
    pub deployed_case_definitions:
        Option<::std::collections::HashMap<String, crate::models::CaseDefinitionDto>>,
