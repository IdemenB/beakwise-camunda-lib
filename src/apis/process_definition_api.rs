...
pub trait ProcessDefinitionApi {
    ...
    fn get_deployed_start_form(&self, id: &str) -> Result<std::path::PathBuf, WorkflowError>;
    ...
    fn get_process_definition_diagram(&self, id: &str)
        -> Result<std::path::PathBuf, WorkflowError>;
    ...
    fn get_rendered_start_form(&self, id: &str) -> Result<std::path::PathBuf, WorkflowError>;
    ...
    fn get_start_form(&self, id: &str) -> Result<crate::models::FormDto, WorkflowError>;
    fn get_start_form_by_key(&self, key: &str) -> Result<crate::models::FormDto, WorkflowError>;
