...
pub trait TaskApi {
    ...
    fn create_task(&self, task_dto: Option<crate::models::TaskDto>) -> Result<(), WorkflowError>;
    fn delegate_task(
        &self,
        id: &str,
        user_id_dto: Option<crate::models::UserIdDto>,
    ) -> Result<(), WorkflowError>;
    fn delete_task(&self, id: &str) -> Result<(), WorkflowError>;
    fn get_deployed_form(&self, id: &str) -> Result<std::path::PathBuf, WorkflowError>;
    fn get_form(&self, id: &str) -> Result<crate::models::FormDto, WorkflowError>;
    ...
    fn get_rendered_form(&self, id: &str) -> Result<std::path::PathBuf, WorkflowError>;
    fn get_task(&self, id: &str) -> Result<crate::models::TaskDto, WorkflowError>;
    fn get_tasks(
        &self,
    ...
    fn unclaim(&self, id: &str) -> Result<(), WorkflowError>;
    fn update_task(
        &self,
        id: &str,
...
impl TaskApi for TaskApiClient {
    ...
    fn get_tasks(
        ...
        if let Some(ref s) = process_instance_business_key_expression {
            req_builder =
                req_builder.query(&[("processInstanceBusinessKeyExpression", &s.to_string())]);
        }
        ...
        if let Some(ref s) = process_instance_business_key_like_expression {
            req_builder =
                req_builder.query(&[("processInstanceBusinessKeyLikeExpression", &s.to_string())]);
        }
        ...
        if let Some(ref s) = follow_up_before_or_not_existent_expression {
            req_builder =
                req_builder.query(&[("followUpBeforeOrNotExistentExpression", &s.to_string())]);
        }
