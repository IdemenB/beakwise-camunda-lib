...
pub trait ProcessInstanceApi {
    ...
    fn get_process_instances(
        ...
        process_definition_key_not_in: Option<&str>,
        deployment_id: Option<&str>,
        super_process_instance: Option<&str>,
        sub_process_instance: Option<&str>,
        super_case_instance: Option<&str>,
        sub_case_instance: Option<&str>,
        active: Option<bool>,
...
impl ProcessInstanceApi for ProcessInstanceApiClient {
    ...
    fn get_process_instances(
        ...
        if let Some(ref s) = process_definition_without_tenant_id {
            req_builder =
                req_builder.query(&[("processDefinitionWithoutTenantId", &s.to_string())]);
        }
