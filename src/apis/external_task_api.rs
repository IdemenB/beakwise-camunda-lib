...
pub trait ExternalTaskApi {
    fn complete_external_task_resource(
        &self,
        id: &str,
    ...
    fn get_external_task(&self, id: &str) -> Result<crate::models::ExternalTaskDto, WorkflowError>;
    fn get_external_task_error_details(&self, id: &str) -> Result<String, WorkflowError>;
    ...
    fn unlock(&self, id: &str) -> Result<(), WorkflowError>;
}
